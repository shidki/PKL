    ...
    <div class="section trending">
        <div class="container">
            <ul class="trending-filter">
                ...
                <li>
                    <a href="" data-filter=".inst">Instansi</a>
                </li>
                <li>
                    <a href="" data-filter=".lain">Fasilitas Lain</a>
                </li>
            </ul>
            {{-- <div class="card-body" style="border: 1px solid black;border-radius: 5px;">
                <input type="text" class="form-control text-center" placeholder="Search" id="search_input">
            </div> --}}
            <div class="row trending-box mt-5">
                @if ($gedung)
                    @foreach ($gedung as $namaGedung)
                        <div id="{{$namaGedung->nama }}" class="col-lg-3 col-md-6 align-self-center mb-30 trending-items col-md-6 {{ $namaGedung->jenis }}">
                            <div class="item" style="height: 350px;">
                                <div class="thumb">
                                    <a href="{{ url('/detail', ['nama' => $namaGedung->nama]) }}">
                                        @if ($namaGedung->gambar !== "")
                                        <img height="200px" src="{{ asset("$namaGedung->gambar")}}" alt="{{ $namaGedung->gambar }}">
                                      @else
                                      <div class="text-center mt-5">
                                        <i class="fa fa-exclamation-triangle" style="font-size: 50px; color: red;"></i>
                                        <h3><strong style="color: red;font-size: 20px;">Gambar belum tersedia</strong></h3>
                                      </div>
                                      @endif
                                    </a>
                                </div>
                                <div class="down-content">
                                    <div>
                                    <h5 class="nama_gedung" style="font-size: 15px;">{{ $namaGedung->nama }}</h5>
                                </div>
                                <div class="mt-4">
