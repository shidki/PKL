        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center">
                    ...
                    <ul>
                        <li><span>Harga Terendah:</span> {{ $penginapan->harga_terendah }}</li>
                        <li><span>Harga Tertinggi::</span> {{ $penginapan->harga_tertinggi }}</li>
                        <li><span>Jarak:</span> {{ $penginapan->jarak }} <strong>Km</strong></li>
                    </ul>
                </div>
                <div class="col-lg-12">
                    <div class="sep"></div>
                                ...
                                <div class="tab-pane  fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <ol type="1" class=" d-flex " style="flex-wrap: wrap; justify-content: space-between">
                                        @foreach ( $fasilitas as $fasilitass )
                                            <li class="d-inline-block mb-3" style="width: 40%;margin-right: 100px;"><span class="d-inline-block" style="margin-right: 10px;"><i class="fa fa-thumb-tack" aria-hidden="true"></i></span><span>{{ $fasilitass->nama }}</span></li>
                                        @endforeach
                                    </ol>
                                </div>
                            </div>
                        ...
                        @if ($count < 4)
                            <div class="col-lg col-sm-6 col-xs-12">
                                <div class="item">
                                    ...
                                    <div class="thumb">
                                        <a href="{{  route('detail_penginapan' ,['nama' => $lainnyas->nama ]) }}"><img src="{{ asset('assets/landing_page/1/assets/images/oyo.jpeg ')}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            @php $count++ @endphp
