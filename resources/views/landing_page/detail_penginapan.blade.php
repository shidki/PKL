...
<body>
    ...
    <div class="hero_area">
        ...
        <div class="hero_bg_box"  style="background-image: url({{ asset("assets/landing_page/images/penginapan.jpg")}}); background-size: 100vw 100vh;">
        ...
        <div class="page-heading header-text">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12" style="text-shadow: 0px 15px 15px black;">
                        <h3>{{ $penginapan->nama }}</h3>
                        <span class="breadcrumb"><a href="/"><strong>Beranda</strong></a> >  {{ $penginapan->nama }}</span>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-image">
                        ...
                        <img height="400px" src="{{ asset("$penginapan->gambar")}}" alt="">
                      @else
                        <img height="400px" src="{{ asset('assets/landing_page/1/assets/images/kamar.jpeg')}}" alt="Penginapan">
                      @endif
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <h4>{{ $penginapan->nama }}</h4>
                    <span class="price"><i class="fa fa-phone"></i> {{ $penginapan->telp }}</span>
                    <p>{{ $penginapan->alamat }}</p>
                    <ul>
                        <li><span>Harga Terendah:</span> Rp. <span style="color: black; font-weight: bold" id="harga_terendah"></span></li>
                        <li><span>Harga Tertinggi::</span> Rp. <span style="color: black; font-weight: bold" id="harga_tertinggi"></span></li>
                        <li><span>Jarak dari balaikota:</span> {{ $penginapan->jarak }} <strong>Km</strong></li>
                    </ul>
                </div>
                <div class="col-lg-12">
                    <div class="sep"></div>
                            ...
                            <div class="nav-wrapper ">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true">Fasilitas</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane  fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <ol type="1" class=" d-flex " style="flex-wrap: wrap; justify-content: space-between">
                                        @foreach ( $fasilitas as $fasilitass )
                                            <li class="d-inline-block mb-3" style="width: 40%;margin-right: 100px;text-transform: uppercase;"><span class="d-inline-block" style="margin-right: 10px;"><i class="fa fa-thumb-tack" aria-hidden="true"></i></span><span>{{ $fasilitass->nama_fasilitas }}</span></li>
                                        @endforeach
                                    </ol>
                                </div>
                            </div>
                        ...
                        @if ($count < 4)
                            <div class="col-lg col-sm-6 col-xs-12">
                                <div class="item">
                                    ...
                                    <div class="thumb">
                                        <a href="{{  route('detail_penginapan' ,['nama' => $lainnyas->nama ]) }}"><img src="{{ asset($lainnyas->gambar)}}" alt="{{ $lainnyas->nama }}"></a>
                                    </div>
                                </div>
                            </div>
                            @php $count++ @endphp
    ...
    <script>
        var hargaTerendah = {{ $penginapan->harga_terendah }};
        var harga_terendah_format = hargaTerendah.toLocaleString('id-ID');
        document.getElementById('harga_terendah').innerHTML = harga_terendah_format;

        var hargatertinggi = {{ $penginapan->harga_tertinggi }};
        var harga_tertinggi_format = hargatertinggi.toLocaleString('id-ID');
        document.getElementById('harga_tertinggi').innerHTML = harga_tertinggi_format;
