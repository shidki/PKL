...
<body>
    ...
    <div class="hero_area">
        ...
        <div class="hero_bg_box"  style="background-image: url({{ asset("assets/landing_page/images/food.jpg")}}); background-size: 100vw 100vh;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12" style="text-shadow: 0px 15px 15px black;">
                        <h3>{{ $kuliner->nama }}</h3>
                        <span class="breadcrumb"><a href="/"><strong>Beranda</strong></a> >  {{ $kuliner->nama }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-image">
                        @if ($kuliner->gambar !== "")
                        <img height="400px" src="{{ asset("$kuliner->gambar")}}" alt="">
                      @else
                        <img height="400px" src="{{ asset('assets/landing_page/1/assets/images/kuliner.png')}}" alt="kuliner">
                      @endif
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    ...
                    <p>{{ $kuliner->alamat }}</p>
                    <ul>
                        <li><span>Jarak dari balaikota:</span> {{ $kuliner->jarak }} <strong>Km</strong></li>
                    </ul>
                </div>
                <div class="col-lg-12">
                    <div class="sep"></div>
                            ...
                            <div class="nav-wrapper ">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true">Menu Yang Disediakan</button>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="tab-pane  fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <ol type="1" class=" d-flex " style="flex-wrap: wrap; justify-content: space-between">
                                        @foreach ( $menu as $menus )
                                            <li class="d-inline-block mb-3" style="width: 40%;margin-right: 100px;"><span class="d-inline-block" style="margin-right: 10px;"><i class="fa fa-cutlery" aria-hidden="true"></i></span><span>{{ $menus->nama }} : Rp. <span style="color: black; font-weight: bold" id="harga_menu{{$menus->nama}}"></span></span></li>
                                                <script>
                                                    var hargamenu = {{ $menus->harga }};
                                                    var harga_menu_format = hargamenu.toLocaleString('id-ID');
                                                    document.getElementById('harga_menu{{$menus->nama}}').innerHTML = harga_menu_format;
                        ...
                        @if ($count < 4)
                            <div class="col-lg col-sm-6 col-xs-12">
                                <div class="item">
                                    ...
                                    <div class="thumb">
                                        <a href="{{  route('detail_penginapan' ,['nama' => $lainnyas->nama ]) }}"><img src="{{ asset($lainnyas->gambar)}}" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            @php $count++ @endphp
