        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center">
                    ...
                    <p>{{ $kuliner->alamat }}</p>
                    <ul>
                        <li><span>Jarak:</span> {{ $kuliner->jarak }} <strong>Km</strong></li>
                    </ul>
                </div>
                <div class="col-lg-12">
                    <div class="sep"></div>
                                ...
                                <div class="tab-pane  fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <ol type="1" class=" d-flex " style="flex-wrap: wrap; justify-content: space-between">
                                        @foreach ( $menu as $menus )
                                            <li class="d-inline-block mb-3" style="width: 40%;margin-right: 100px;"><span class="d-inline-block" style="margin-right: 10px;"><i class="fa fa-cutlery" aria-hidden="true"></i></span><span>{{ $menus->nama }} : {{ $menus->harga }}</span></li>
                                        @endforeach
                                    </ol>
                                </div>
                            </div>
