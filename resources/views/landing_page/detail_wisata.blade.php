...
<body>
    ...
    <div class="hero_area">
        ...
        <div class="hero_bg_box"  style="background-image: url({{ asset("assets/landing_page/images/wisata2.jpg")}}); background-size: 100vw 100vh;">
                        ...
                        @if ($count < 4)
                            <div class="col-lg col-sm-6 col-xs-12">
                                <div class="item">
                                    ...
                                    <div class="thumb">
                                        <a href="{{  route('detail_wisata' ,['nama' => $lainnyas->nama ]) }}"><img height="200px" src="{{ asset($lainnyas->gambar)}}" alt="{{ $lainnyas->nama }}"></a>
                                    </div>
                                </div>
                            </div>
                            @php $count++ @endphp
    ...
    <script>
        var hargaTiketWeekdays = {{ $wisata->harga_tiket }};
        var hargaTiketFormattedWeekdays = hargaTiketWeekdays.toLocaleString('id-ID');
        document.getElementById('hargaTiketFormattedWeekdays').innerHTML = hargaTiketFormattedWeekdays;

        var hargaTiketWeekend = {{ $wisata->harga_weekend }};
        var hargaTiketFormattedWeekend = hargaTiketWeekend.toLocaleString('id-ID');
        document.getElementById('hargaTiketFormattedWeekend').innerHTML = hargaTiketFormattedWeekend;
      </script>
